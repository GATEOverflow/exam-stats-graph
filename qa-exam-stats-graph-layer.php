...
class qa_html_theme_layer extends qa_html_theme_base {
    ...
    public function head_css() {
        ...
        // Activity Heatmap CSS (user profile only)
        if ($this->template == 'user') {
            ...
            <style>
                ...
                .qa-heatmap-privacy-btn:hover {
                    background: #e0e0e0;
                }
                [data-theme="dark"] .qa-heatmap-privacy-btn,
                .dark .qa-heatmap-privacy-btn {
                    background: #4a4d52;
                    border-color: #666;
                    color: #f9f9f9;
                }
                [data-theme="dark"] .qa-heatmap-privacy-btn:hover,
                .dark .qa-heatmap-privacy-btn:hover {
                    background: #5a5d62;
                }
            </style>
            ');
    ...
    public function head_script() {
        ...
        // Activity Heatmap JS libraries (user profile only)
        if ($this->template == 'user') {
